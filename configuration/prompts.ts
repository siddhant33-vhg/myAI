...
You couldn't perform a proper search for the user's question, but still answer the question starting with "Although i do not have contemperory data to answer this question, I have some knowledge about it then proceed to answer the question based on your knowledge of ${OWNER_NAME}.
